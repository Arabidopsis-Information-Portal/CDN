...
class App
	...
	call: (options, deferred, autocutoff) =>
		...
		#"https://api.araport.org/data/ATTED_coex/alpha_prime/?At3g08940/cor/0.7"
		url = "https://api.araport.org/data/ATTED_coex/alpha_prime/?#{@opts.AGIcode}/#{options.method}/#{options.cutoff}"
